      ...
      <view class="wrap" :class="{ show: open }">
         ...
         <view class="picker-body">
            <picker-view :value="value" @change="_onChange">
               <picker-view-column v-if="type<4">
               ...
               <picker-view-column v-if="type==1  || type==2">
                  <view class="column-item" v-for="item in days" :key="item">
                     {{ item | formatNum }}日
                  </view>
               </picker-view-column>
               <picker-view-column  v-if="type==1 || type== 4">
...
export default {
   ...
   methods: {
      ...
      setSelectValue() {
		 if(this.sortDate){
			 this.year = this.years[this.value[this.sortDate[0]]];
			 this.month = this.months[this.value[this.sortDate[1]]];
			 this.day = this.days[this.value[this.sortDate[2]]];
			 this.hour = this.hours[this.value[this.sortDate[3]]];
			 this.minute = this.minutes[this.value[this.sortDate[4]]]; 
		 }else{
